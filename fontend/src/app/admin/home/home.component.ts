...
import { AdminPostService } from '../modules/admin/post.service';
import { AdminUserService } from '../modules/admin/user.service';
import { AdminCategoryService } from '../modules/admin/category.service';
import { AdminLanguageService } from '../modules/admin/language.service';
@Component({
